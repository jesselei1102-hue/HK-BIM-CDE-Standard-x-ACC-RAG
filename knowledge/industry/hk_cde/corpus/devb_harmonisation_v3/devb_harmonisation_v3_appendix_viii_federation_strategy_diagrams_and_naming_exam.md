...
section_id: devb_harmonisation_v3_appendix_viii_federation_strategy_diagrams_and_naming_exam
title: Appendix VIII - Federation Strategy Diagrams and Naming Examples (v2)
page_start: 117
page_end: 129
...
priority: high
language: en
source_url: hk_cde://devb_harmonisation_v3/devb_harmonisation_v3_appendix_viii_federation_strategy_diagrams_and_naming_exam
---

# Appendix VIII - Federation Strategy Diagrams and Naming Examples (v2)

DEVB BIM HARMONISATION GUIDELINES 
FOR WORKS DEPARTMENTS APPENDIX VIII  
 
 
 
 – Federation Strategy Diagrams and Naming Examples 
...
subdisciplines, while walkway cover, subway cover and concrete structural frame of lift tower s hould belong to other discipline s such as 
...
1.1. Federation Strategy for Field 3.2 (System): Building 
...
1.2. Federation Strategy for Field 3.2 (System): District Cooling System, Electrical Power Supply, Gas Supply, St ormwater Drainage, 
Telecommunications 
...
1.3. Federation Strategy for Field 3.2 (System): General Site Information, Geotechnical, Landscape  
...
1.4. Federation Strategy for Field 3.2 (System): Sewerage  
...
1.5. Federation Strategy for Field 3.2 (System): Water Supply 
...
1.6. Federation Strategy for Field 3.2 (System): Road and Highway Structures 
...
2. Naming Examples for BIM Model 
...
2.2. Naming Example – Sewage Pumping Station in Volume C2 
...
2.3. Naming Example – a Market in Volume C6 
...
3. Naming Example for Drawings Generated from BIM Model 
