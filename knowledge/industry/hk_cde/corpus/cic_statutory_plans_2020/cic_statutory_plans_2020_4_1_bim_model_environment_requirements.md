...
section_id: cic_statutory_plans_2020_4_1_bim_model_environment_requirements
title: 4.1 BIM Model Environment Requirements
page_start: 17
page_end: 17
authority: CIC Statutory Plan Submissions 2020 §4.1
...
priority: high
language: en
source_url: hk_cde://cic_statutory_plans_2020/cic_statutory_plans_2020_4_1_bim_model_environment_requirements
---
...
All BIM models w ould have the common objects built in the individual model, copied from 
...
Floor Level (FFL) and Structural Floor Level (SFL) are provided in the GB P, levels in the 
