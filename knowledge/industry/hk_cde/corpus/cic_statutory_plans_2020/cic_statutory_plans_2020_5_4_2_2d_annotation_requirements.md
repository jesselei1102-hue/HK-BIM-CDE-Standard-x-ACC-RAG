...
section_id: cic_statutory_plans_2020_5_4_2_2d_annotation_requirements
title: 5.4.2 2D Annotation requirements
page_start: 40
page_end: 40
authority: CIC Statutory Plan Submissions 2020 §5.4.2
...
priority: high
language: en
source_url: hk_cde://cic_statutory_plans_2020/cic_statutory_plans_2020_5_4_2_2d_annotation_requirements
---
...
Monitoring 
Instrument 
• Generic Object with a symbolic 
...
Layer of excavation 
level 
Tag • Tag linked with the ‘line’ according to each 
topographic layer. 
Design Ground Water 
Table (G.W.T.) 
Tag • Tag linked with the ‘line’ according to the 
designated level of G.W.T. 
(Section) Offset value 
of Borehole from the 
section cut location 
Symbol • Symbol present with text ‘OFFSET’ and the value 
of offset dimension to be input manually. 
